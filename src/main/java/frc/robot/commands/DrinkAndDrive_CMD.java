...
public class DrinkAndDrive_CMD extends Command {
  /** Creates a new DrinkAndDrive_CMD. */
  private final Swerve_SS mswerveDrive;
  private final XboxController controller;
  public DrinkAndDrive_CMD(Swerve_SS mswerveDrive, XboxController controller) {
  ...
  public void execute() {
    ...
    mswerveDrive.drinkanddrive(fwd, strf, drift);
  }
